 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri May 12 16:35:58 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                sfbuilder_movingAvg
...
/* Parameter 0 */
#define PARAMETER_0_NAME               windowSize
...
extern void sfbuilder_movingAvg_Start_wrapper(real_T *xD,
  void **pW,
  const real_T *windowSize, const int_T p_width0);
extern void sfbuilder_movingAvg_Outputs_wrapper(const real_T *in,
  real_T *avg,
  real_T *std,
  const real_T *xD,
  void **pW,
  const real_T *windowSize, const int_T p_width0);
extern void sfbuilder_movingAvg_Update_wrapper(const real_T *in,
  real_T *avg,
  real_T *std,
  real_T *xD,
  void **pW,
  const real_T *windowSize, const int_T p_width0);
extern void sfbuilder_movingAvg_Terminate_wrapper(real_T *xD,
  void **pW,
  const real_T *windowSize, const int_T p_width0);
...
static void mdlStart(SimStruct *S)
{
  ...
  const real_T *windowSize = (const real_T *) mxGetData(PARAM_DEF0(S));
  sfbuilder_movingAvg_Start_wrapper(xD, pW, windowSize, p_width0);
}
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real_T *avg = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *std = (real_T *) ssGetOutputPortRealSignal(S, 1);
  const real_T *xD = ssGetDiscStates(S);
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const real_T *windowSize = (const real_T *) mxGetData(PARAM_DEF0(S));
  sfbuilder_movingAvg_Outputs_wrapper(in, avg, std, xD, pW, windowSize, p_width0);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const real_T *windowSize = (const real_T *) mxGetData(PARAM_DEF0(S));
  sfbuilder_movingAvg_Update_wrapper(in, avg, std, xD, pW, windowSize, p_width0);
}
...
static void mdlTerminate(SimStruct *S)
{
  ...
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const real_T *windowSize = (const real_T *) mxGetData(PARAM_DEF0(S));
  sfbuilder_movingAvg_Terminate_wrapper(xD, pW, windowSize, p_width0);
}
